...
namespace graph {
    ...
    private:
        struct RouteInternalData {
            Weight weight;
            std::optional<EdgeId> prev_edge; /*Предыдущее ребро*/
        };
        using RoutesInternalData = std::vector<std::vector<std::optional<RouteInternalData>>>;

        /*Инициализирует матрицу вершина - ребро{длина, id}*/
        ...
        /*Создает путь между двумя вершинами через промежуточную вершину, либо сокращает путь через промежуточную вершину*/
